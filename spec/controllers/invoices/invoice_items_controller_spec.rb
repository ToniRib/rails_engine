...
RSpec.describe Api::V1::Invoices::InvoiceItemsController, type: :controller do
  describe "GET #index.json" do
    ...
    it "returns all of the invoice's invoice items in JSON format" do
      ...
      expect(json_response.first["unit_price"]).to eq(invoice_items.first.unit_price.to_s)
      ...
      expect(json_response.last["unit_price"]).to eq(invoice_items.last.unit_price.to_s)
